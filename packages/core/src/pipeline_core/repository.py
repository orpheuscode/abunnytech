...
class RunRepository:
    ...
    def set_artifact(self, run_id: str, artifact_type: str, payload: dict[str, Any]) -> None:
    ...
    def get_artifact(self, run_id: str, artifact_type: str) -> dict[str, Any] | None:
    ...
    def get_all_artifacts(self, run_id: str) -> dict[str, dict[str, Any]]:
