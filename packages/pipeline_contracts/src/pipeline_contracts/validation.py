...
def validate_payload[T: BaseModel](model_cls: type[T], data: dict[str, Any] | str | bytes) -> T:
...
def validate_payload_from_path[T: BaseModel](model_cls: type[T], path: Path) -> T:
